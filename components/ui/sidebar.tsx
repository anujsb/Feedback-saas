...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full min-h-screen px-4 py-4 hidden  md:flex md:flex-col bg-primary w-[300px] flex-shrink-0 border-r border-secondary shadow-md ",
          className
        )}
        animate={{
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 bg-transparent backdrop-blur-sm p-10 z-[100] flex flex-col justify-between",
                className
              )}
            >
              <div
